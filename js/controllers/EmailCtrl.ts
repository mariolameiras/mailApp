...
module mail {
	...
	export class EmailCtrl {
		...
		constructor(
			...
			private todoStorage: EmailStorage,
		...
		addTodo() {
			...
			this.todos.push(new Email(newTodo, newTodo, newTodo, newTodo, false, false));
			this.$scope.newTodo = '';
		}

		editTodo(todoItem: Email) {
			this.$scope.editedTodo = todoItem;
		}

		doneEditing(todoItem: Email) {
